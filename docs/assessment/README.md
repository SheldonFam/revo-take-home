...
> Original take-home brief, kept verbatim for context. The shipped implementation, run instructions, and API documentation live in the root [`README.md`](../../README.md).
...
Two reference screenshots are provided in the [`reference/`](./reference) folder:

### Admin Dashboard
![Admin Dashboard](./reference/admin-dashboard.png)

### Workflow Builder
![Workflow Builder](./reference/workflow.png)
